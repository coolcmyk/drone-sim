# Experimental patches — NOT applied by `runtime/local/build_airsim_wrapper.sh`

The build script globs `simulator/unreal/patches/cosys-airsim/*.patch`, so anything in this subdirectory is

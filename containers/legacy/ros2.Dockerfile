...
# `ros2/src/bringup/launch/perception.launch.py` (`/airsim_node/clock` -> `/clock`).
#
...
# every bring-up by runtime/local/build_airsim_wrapper.sh.
#
...
# no longer exists.
COPY runtime/local/ros-profile.sh /etc/profile.d/10-ros.sh

...
| [`docs/architecture.html`](docs/architecture.html) | **What runs and what moves** — the four containers, what each holds, and the three transports between them, with the one that is actually the control interface marked |

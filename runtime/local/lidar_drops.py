...
----------------------
`simulator/unreal/patches/cosys-airsim/0006` makes a failed GPU-LiDAR readback survivable: instead of crashing,
...
import it, shell callers invoke it as a CLI.
    ...
    python3 runtime/local/lidar_drops.py            -> prints the count, exits 0

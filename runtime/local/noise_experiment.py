...
_spec = importlib.util.spec_from_file_location("capexp", REPO / "runtime" / "local" / "capture_experiment.py")
cap = importlib.util.module_from_spec(_spec)
_spec.loader.exec_module(cap)
_vspec = importlib.util.spec_from_file_location("vsnative", REPO / "runtime" / "local" / "capture_vs_native.py")
    ...
    for vname, (extra, console, scale, down) in variants.items():
        ...
        try:
            ...
            for label, x, y, z, yaw in SCENES:
                ...
                cmd = [
                    "/runtime/local/_capture_noise.py", "--out", f"/out/{label}_airsim.png",

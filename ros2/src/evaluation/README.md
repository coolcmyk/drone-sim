...
[`runtime/local/run_scenario.py`](../../../runtime/local/run_scenario.py) runs one seeded mission and
emits a JSON result beside its MCAP; [`runtime/local/run_gate.py`](../../../runtime/local/run_gate.py) is
